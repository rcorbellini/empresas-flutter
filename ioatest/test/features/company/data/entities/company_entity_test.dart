...
void main() {
  ...
  test('Json must create a valid entity', () {
    ...
    expect(
        result.description,
        'Lifebit is building a cloud-based cognitive system that '
        'can reason about DNA data in the same way as humans. '
        'This offers researchers and R&D professionals, with '
        'limited-to-no computational and data analysis training,'
        ' and their corresponding organisations (ie. '
        'pharmaceutical companies), a highly scalable, modular '
        'and reproducible system that automates the analysis '
        'processes, learns from the data and provides actionable insights.');
