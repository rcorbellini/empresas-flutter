...
class CompanyDi implements InjectorModule {
  ...
  void initialise(BaseInjector injector) {
    ...
    //presentation
    injector
        .register((injector) => HomeBloc(loadCompanyByName: injector.get(), navigationService: injector.get()));

    injector
        .register((injector) => CompanyDetailBloc(loadCompanyById: injector.get(), navigationService: injector.get()));

    injector.register((injector) => LoginBloc(navigationService: injector.get()));
  }
}
